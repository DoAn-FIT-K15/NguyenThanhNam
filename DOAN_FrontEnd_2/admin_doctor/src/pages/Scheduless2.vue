            ...
            <div class="col-md-6 col-12 mt-3 mb-3">
              <div class="ml-10 mr-10">
                ...
                <ul class="row mt-2 mb-2">
                  <li class="schedule-item col-xl-3 col-lg-4 col-md-6 col-sm-4 col-6" v-for="schedule in listSche.scheduleResponses" :key="schedule.time" 
                  @click="handleScheduleClick(listSche, schedule)">
              ...
              <div class="scheduleInfor" style="font-size: 14px;">
                ...
                <div class="mt-2 ml-10 mr-10">
                  GIÁ KHÁM: 
                  <span style="margin-bottom: 0; font-weight: 550;">{{ listSche.price }}.000đ</span>
                </div>
              </div>
            </div>
          </div>
